...
{
    public class ReservePaymentViewModels
    {
        [StringLength(30)]
    ...
    public class ReservePaymentDetailsViewModels : DetailsViewModels
    {
        private readonly IHttpContextAccessor _httpContextAccessor;

        public ReservePaymentDetailsViewModels(IHttpContextAccessor httpContextAccessor) : base()
        {
        ...
        public bool HasUnpaidPreviousReserveLedger { get; set; }

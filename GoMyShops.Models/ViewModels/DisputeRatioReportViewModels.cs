...
{
    public class DisputeRatioReportViewModels
    {
        ...
        public string srcTransactionType { get; set; }
        ...
        public List<DisputeRatioReportListViewModels> DisputeRatioReportList { get; set; }
        public DisputeRatioReportListViewModels DisputeRatioReportTotal { get; set; }
    ...
    public class DisputeRatioReportListViewModels : ActionsListViewModels
    {
        ...
        public decimal DisputeTransactionCount { get; set; }
        public decimal DisputeTransactionAmount { get; set; }
        public string sDisputeTransactionAmount { get; set; }

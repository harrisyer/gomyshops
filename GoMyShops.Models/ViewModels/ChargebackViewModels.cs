...
namespace GoMyShops.Models.ViewModels
{
    public class ChargebackViewModels
    {
        ...
        public IEnumerable<SelectListItem> ChargebackTypeDDL { get; set; }
    ...
    public class ChargebackListViewModels : ActionsListViewModels
    {
    ...
    public class ChargebackDetailsViewModels : DetailsViewModels
    {
        private readonly IHttpContextAccessor _httpContextAccessor;

        public ChargebackDetailsViewModels(IHttpContextAccessor httpContextAccessor) : base()
        {
        ...
        public string ChargebackComment { get; set; }
        ...
        public IEnumerable<SelectListItem> ChargebackReasonDDL { get; set; }
        ...
        public bool IsShowReasonSelection { get; set; }
        #endregion

...
{
    public class RetrievalViewModels
    {
        ...
        public IEnumerable<SelectListItem> RetrievalTypeDDL { get; set; }

        public string Title { get; set; }
        #endregion
    }

    public class RetrievalListViewModels : ActionsListViewModels
    {
    ...
    public class RetrievalDetailsViewModels : DetailsViewModels
    {
        private readonly IHttpContextAccessor _httpContextAccessor;

        public RetrievalDetailsViewModels(IHttpContextAccessor httpContextAccessor) : base()
        {
        ...
        public IEnumerable<SelectListItem> RetrievalReasonDDL { get; set; }
